...
unsigned char *scrypt_buffer_alloc_sse(int N);
...
int scanhash_scrypt_sse(int thr_id, struct work *work, uint32_t max_nonce, uint64_t *hashes_done, unsigned char *scratchbuf, uint32_t N);
